...
Each one of these images was noised with 5 different types of noise: Gaussian, Rician, uniform, salt and pepper and speckler noise. While the first four types of noise are additive, the last one is multiplicative. Specifically, the characteristic parameters of the each kind of noise are represented in Table \ref{tb:noising_parameters}.
