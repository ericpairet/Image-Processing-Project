...
io.imsave('lena_uni.jpg',lena_uni)
lena_nor = nor(lena,0.1)
io.imsave('lena_nor.jpg',lena_nor)
lena_ric = ric(lena,0.1,0.05)
io.imsave('lena_ric.jpg',lena_ric)
lena_sp = saltNpepper(lena,0.1)
io.imsave('lena_sp.jpg',lena_sp)

# Cameraman
cameraman = sk.img_as_float(io.imread('cameraman.bmp'))
cameraman_uni = uni(cameraman,0.1)
io.imsave('cameraman_uni.jpg',cameraman_uni)
cameraman_nor = nor(cameraman,0.1)
io.imsave('cameraman_nor.jpg',cameraman_nor)
cameraman_ric = ric(cameraman,0.1,0.05)
io.imsave('cameraman_ric.jpg',cameraman_ric)
cameraman_sp = saltNpepper(cameraman,0.1)
io.imsave('cameraman_sp.jpg',cameraman_sp)

# Baboon
baboon = sk.img_as_float(io.imread('baboon.bmp'))
baboon_uni = uni(baboon,0.1)
io.imsave('baboon_uni.jpg',baboon_uni)
baboon_nor = nor(baboon,0.1)
io.imsave('baboon_nor.jpg',baboon_nor)
baboon_ric = ric(baboon,0.1,0.05)
io.imsave('baboon_ric.jpg',baboon_ric)
baboon_sp = saltNpepper(baboon,0.1)
io.imsave('baboon_sp.jpg',baboon_sp)
