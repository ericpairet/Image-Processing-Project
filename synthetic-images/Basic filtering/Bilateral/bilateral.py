# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 13:06:26 2015
...
# Apply filters
lena_uni_f = sk.img_as_float(res.denoise_bilateral(lena_uni))
lena_nor_f = sk.img_as_float(res.denoise_bilateral(lena_nor))
lena_ric_f = sk.img_as_float(res.denoise_bilateral(lena_ric))
lena_sp_f = sk.img_as_float(res.denoise_bilateral(lena_sp))

cameraman_uni_f = sk.img_as_float(res.denoise_bilateral(cameraman_uni))
cameraman_nor_f = sk.img_as_float(res.denoise_bilateral(cameraman_nor))
cameraman_ric_f = sk.img_as_float(res.denoise_bilateral(cameraman_ric))
cameraman_sp_f = sk.img_as_float(res.denoise_bilateral(cameraman_sp))

baboon_uni_f = sk.img_as_float(res.denoise_bilateral(baboon_uni))
baboon_nor_f = sk.img_as_float(res.denoise_bilateral(baboon_nor))
baboon_ric_f = sk.img_as_float(res.denoise_bilateral(baboon_ric))
baboon_sp_f = sk.img_as_float(res.denoise_bilateral(baboon_sp))
