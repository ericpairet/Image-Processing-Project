# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 12:45:51 2015
...
# Apply filters
lena_uni_f = sk.img_as_float(fil.rank.mean_percentile(lena_uni,k,p0=0.3,p1=0.7))
lena_nor_f = sk.img_as_float(fil.rank.mean_percentile(lena_nor,k,p0=0.3,p1=0.7))
lena_ric_f = sk.img_as_float(fil.rank.mean_percentile(lena_ric,k,p0=0.3,p1=0.7))
lena_sp_f = sk.img_as_float(fil.rank.mean_percentile(lena_sp,k,p0=0.3,p1=0.7))

cameraman_uni_f = sk.img_as_float(fil.rank.mean_percentile(cameraman_uni,k,p0=0.3,p1=0.7))
cameraman_nor_f = sk.img_as_float(fil.rank.mean_percentile(cameraman_nor,k,p0=0.3,p1=0.7))
cameraman_ric_f = sk.img_as_float(fil.rank.mean_percentile(cameraman_ric,k,p0=0.3,p1=0.7))
cameraman_sp_f = sk.img_as_float(fil.rank.mean_percentile(cameraman_sp,k,p0=0.3,p1=0.7))

baboon_uni_f = sk.img_as_float(fil.rank.mean_percentile(baboon_uni,k,p0=0.3,p1=0.7))
baboon_nor_f = sk.img_as_float(fil.rank.mean_percentile(baboon_nor,k,p0=0.3,p1=0.7))
baboon_ric_f = sk.img_as_float(fil.rank.mean_percentile(baboon_ric,k,p0=0.3,p1=0.7))
baboon_sp_f = sk.img_as_float(fil.rank.mean_percentile(baboon_sp,k,p0=0.3,p1=0.7))
